...
from bookingconfirmedcall import make_booking_confirmed_call
...
def register_booking_confirmed_call_routes(app):

    # ------------------------------------------------------------------
    # 1. AUTO-TRIGGER: GET /booking_confirmed_call
    # ------------------------------------------------------------------
    @app.route('/booking_confirmed_call', methods=['GET'])
    def booking_confirmed_call():
        ...
        threading.Thread(
            target=make_booking_confirmed_call,
    ...
    # ------------------------------------------------------------------
    # 2. MANUAL TRIGGER: POST /booking_confirmed_call/trigger/<confirm_id>
    # ------------------------------------------------------------------
    @app.route('/booking_confirmed_call/trigger/<confirm_id>', methods=['POST'])
    def booking_confirmed_call_trigger(confirm_id):
        allowed, server_time = is_within_call_window()
    ...
    # ------------------------------------------------------------------
    # 3. DEBUG: GET /debug-booking-confirmed-call
    # ------------------------------------------------------------------
    @app.route('/debug-booking-confirmed-call')
    def debug_booking_confirmed_call():
        allowed, now = is_within_call_window()
        return jsonify({
            "debug":          "booking_confirmed_call.py loaded",
