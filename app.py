...
from shift_booking_whatsapp import register_shift_booking_whatsapp_routes, register_wati_webhook_routes
from shift_booking_email import register_shift_booking_email_routes
from shift_booking_sms import register_shift_booking_sms_routes, register_telnyx_webhook_routes
from shift_group_booking_email import register_shift_group_booking_email_routes
from shift_group_booking_sms import register_shift_group_booking_sms_routes
from shift_group_booking_whatsapp import register_shift_group_booking_whatsapp_routes
...
from requested_confirm_call import register_requested_confirm_call_routes
from booking_confirmed_call import register_booking_confirmed_call_routes
...
register_wati_webhook_routes(app)
register_shift_booking_email_routes(app)
register_shift_booking_sms_routes(app)
register_shift_group_booking_sms_routes(app)
register_telnyx_webhook_routes(app)
register_shift_group_booking_email_routes(app)
register_shift_group_booking_whatsapp_routes(app)
...
register_requested_confirm_call_routes(app)
register_booking_confirmed_call_routes(app)
