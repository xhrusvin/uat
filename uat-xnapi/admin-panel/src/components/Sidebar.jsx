...
const NAV = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'prompts', to: '/master/prompts', label: 'Prompts',
        icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>,
        description: 'Manage AI prompts',
      },
      {
        id: 'genders', to: '/master/genders', label: 'Genders',
        icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>,
        description: 'Manage genders',
      },
      {
        id: 'user-sub-types', to: '/master/user-sub-types', label: 'User Sub Types',
        icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>,
        description: 'Manage user sub types',
      },
      {
        id: 'qqi-statuses', to: '/master/qqi-statuses', label: 'QQI Statuses',
        icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>,
        description: 'Manage QQI statuses',
      },
      {
        id: 'visa-types', to: '/master/visa-types', label: 'Visa Types',
      ...
      {
        id: 'session-users', to: '/master/session-users', label: 'Session Users',
        ...
        description: 'Manage synced administration users',
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        id: 'xn-qqi-status', to: '/xn-api/qqi-status-list', label: 'QQI Status List',
        icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>,
        description: 'QQI status list from upstream',
      },
      {
        id: 'xn-user-type-list', to: '/xn-api/user-type-list', label: 'User Type List',
        icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/></svg>,
        description: 'Sync user types from upstream',
      },
      {
        id: 'xn-admin-user-list', to: '/xn-api/admin-user-list', label: 'Administration Users',
        icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>,
        description: 'Fetch & sync admin users to session_users',
      },
    ],
  },
  {
    ...
    children: [
      ...
      {
        id: 'webhook-client-updated', to: '/webhook/client-updated', label: 'Client Updated',
        icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>,
        description: 'View client updated webhooks',
      },
    ],
  },
  {
    ...
    children: [
      {
        id: 'wati-broadcast', to: '/whatsapp/broadcast', label: 'Broadcast',
              ...
              return (
                <div key={item.id}>
                  ...
                  {!collapsed && ((item.id === 'master' ? masterExpanded : xnExpanded) || active) && (
                    <div className={`ml-4 mt-0.5 pl-3 border-l-2 border-gray-100 space-y-0.5 ${item.id === 'master' ? 'max-h-64 overflow-y-auto pr-1' : ''}`}>
