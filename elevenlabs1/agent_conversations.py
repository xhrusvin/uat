...
conversations_collection = db["website_leads_conv"]  # UI TRANSCRIPTS ONLY
...
# ==================== ROUTE ====================
@bp.route("/api/elevenlabs/agent/conversations", methods=["GET", "POST"])
    ...
    try:
        ...
        for conv in conversations:
            ...
            try:
                ...
                # 🚫 PROTECT CRM FROM MISCONFIGURED SCHEMAS
                if is_call_status_value(name_val):
                    name_val = None
                if is_call_status_value(email_val):
                    email_val = None
