# elevenlabs/agent_conversations_onboarding_call.py
...
# ==================== BLUEPRINT ====================
bp = Blueprint("elevenlabs_bp_onboarding_call", __name__)
...
conversations_collection = db["onboarding_cov"]  # UI TRANSCRIPTS ONLY
...
# ==================== ROUTE ====================
@bp.route("/api/elevenlabs/agent/conversations_onboarding_call", methods=["GET", "POST"])
def sync_agent_conversations_onboarding_call():
