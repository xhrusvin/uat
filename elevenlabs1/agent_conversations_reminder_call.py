# elevenlabs/agent_conversations_intro_call.py
...
# ==================== BLUEPRINT ====================
bp = Blueprint("elevenlabs_bp_reminder_call", __name__)
...
leads_collection = db["users"]          # CLEAN CRM DATA
conversations_collection = db["reminder_conversations"]  # UI TRANSCRIPTS ONLY
users = db["users"]
...
# ==================== ROUTE ====================
@bp.route("/api/elevenlabs/agent/conversations_reminder_call", methods=["GET", "POST"])
def sync_agent_conversations_reminder_call():
