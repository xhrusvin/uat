...
leads_collection = db["shifts_group_users"]          # CLEAN CRM DATA
conversations_collection = db["shift_booking_bulk_conv"]  # UI TRANSCRIPTS ONLY
...
# ==================== ROUTE ====================
@bp.route("/api/elevenlabs/agent/conversations_shift_bulk_booking", methods=["GET", "POST"])
def sync_agent_conversations_shift_bulk_booking():
    ...
    try:
        ...
        for conv in conversations:
            ...
            try:
                ...
                client_data = full_details.get("conversation_initiation_client_data", {})
