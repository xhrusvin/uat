...
# ==================== BLUEPRINT ====================
bp = Blueprint("elevenlabs_bp_request_confirm", __name__)
...
leads_collection = db["requested_confirm"]          # CLEAN CRM DATA
conversations_collection = db["requested_confirm_call_conversations"]  # UI TRANSCRIPTS ONLY
